...
int main() {
    cornell_w_sphere();
    // FixedPoint temp1 = FixedPoint(-275.999);
    // FixedPoint temp2 = FixedPoint(-211.514);
    // std::cout << "DIVISION " << (temp1/temp2).toDouble() << std::endl;
    // point3 pt = point3(308025, 0, 0);
    // point3 pt2 = point3(308025, 0, 0);
    // point3 tmp = pt2 * pt;
    // std::cout << "e[0] = " << tmp << std::endl;
    // FixedPoint e[3];  // Array of three FixedPoint instances
    // e[0] = FixedPoint(pt.x());
    // e[1] = FixedPoint(555);
    // e[2] = e[0] * e[1];

    // std::cout << "e[0] = " << e[0].toDouble() << std::endl;
    // std::cout << "e[1] = " << e[1].toDouble() << std::endl;
    // std::cout << "e[2] = " << e[2].toDouble() << std::endl;

    // FixedPoint a22 = FixedPoint(3.5);
    ...
    // FixedPoint b20 = FixedPoint(.1515);
