...
class hit_record {
  public:
    ...
    FixedPoint t;           // The parameter `t` for the ray equation P(t) = A + tb. Represents how far along the ray the hit occurs.
    FixedPoint u;
    FixedPoint v;
    ...
    void set_face_normal(const ray& r, const vec3& outward_normal) {
        front_face = (dot(r.direction(), outward_normal)).toDouble() < 0;
