...
#Synthesize the design for TP=64
project new
...
directive set -DESIGN_HIERARCHY { dct dct_h dct_v}
go compile
...
directive set /dct/dct_h/core/PRE_ADD -UNROLL yes
directive set /dct/dct_h/core/MAC -UNROLL yes
...
directive set /dct/dct_v/core/PRE_ADD -UNROLL yes
directive set /dct/dct_v/core/MAC -UNROLL yes
go architect
go extract
