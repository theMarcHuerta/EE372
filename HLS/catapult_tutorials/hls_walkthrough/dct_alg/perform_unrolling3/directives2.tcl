...
directive set /dct/core/inner2 -PIPELINE_INIT_INTERVAL 0
directive set /dct/core/COL0 -PIPELINE_INIT_INTERVAL 0
directive set /dct/core/ROW1 -PIPELINE_INIT_INTERVAL 0
directive set /dct/core/inner1 -UNROLL yes
directive set /dct/core/inner2 -UNROLL yes
directive set /dct/core/main -PIPELINE_INIT_INTERVAL 8
directive set /dct/core/COPY_ROW0 -UNROLL yes
directive set /dct/core/COL0 -UNROLL yes
directive set /dct/core/COPY_ROW1 -UNROLL yes
directive set /dct/core/ROW1 -UNROLL yes
go architect
go extract
