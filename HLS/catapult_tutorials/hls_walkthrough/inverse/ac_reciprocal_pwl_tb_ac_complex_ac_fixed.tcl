...
options set Input/CompilerFlags {-DTEST_RECIPROCAL_AC_COMPLEX_AC_FIXED}
...
solution options set Input/CompilerFlags {-DTEST_RECIPROCAL_AC_COMPLEX_AC_FIXED}
...
flow package option set /SCVerify/INVOKE_ARGS {0 15 0.01 4.0}
