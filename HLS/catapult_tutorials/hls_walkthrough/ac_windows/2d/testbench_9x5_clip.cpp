...
//     This example illustrates using a non-square kernel (9x5)
...
CCS_MAIN(int argc, char *argv[])
{
  ...
  enum {
    ...
    IMG_H        = 200,
    K_R          = 9,         // These enums configure the Kernel size (non-square kernel)
    K_C          = 5,
  ...
  // Sobel kernel data
  const ref_kType ref_cx[K_R][K_C]    = { -1,  0,  1, -2,  0, 
                                           1,  2, -1,  0,  1,
                                          -1,  0,  1, -2,  0,
                                           1,  2, -1,  0,  1,
                                          -1,  0,  1, -2,  0,
  ...
  const ref_kType ref_cy[K_R][K_C]    = {  1,  2,  1,  0,  0,
                                          -1, -1, -2, -1, -1,
                                           1,  2,  1,  0,  0,
                                          -1, -1, -2, -1, -1,
                                           1,  2,  1,  0,  0,
