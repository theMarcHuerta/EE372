...
options set Input/CompilerFlags -DTEST_SQRT_AC_FLOAT
options set Input/CppStandard c++11

# Start a new project to have the above change take effect
project new

solution options set Input/CompilerFlags -DTEST_SQRT_AC_FLOAT
solution options set Input/CppStandard c++11

flow package require /SCVerify
flow package option set /SCVerify/USE_CCS_BLOCK true
# Configure C++ testbench options
flow package option set /SCVerify/INVOKE_ARGS {0 1200 4 1.0 1.0}
