...
# unroll loops in AC math functions
go assembly
...
# pipeline the design in bubble mode  
directive set /StallModes/core/main -PIPELINE_INIT_INTERVAL 1
directive set /StallModes/core/main -PIPELINE_STALL_MODE flush
go extract
