...
directive set /mem_intf/core/VECTOR_ADD -UNROLL 4
...
directive set /mem_intf/op1 -WORD_WIDTH 32 

directive set /mem_intf/op2 -BASE_ADDR 0
directive set /mem_intf/op2 -BASE_BIT  32 
directive set /mem_intf/op2 -WORD_WIDTH 24 

directive set /mem_intf/result -BASE_ADDR 0
directive set /mem_intf/result -BASE_BIT 56 
directive set /mem_intf/result -WORD_WIDTH 36
