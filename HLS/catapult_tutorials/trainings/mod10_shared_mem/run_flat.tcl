...
solution file add ${sfd}/src/simple_reorder.cpp
...
# Pipeline the design and set Stall Mode to 'flush'
directive set /packet_reorder/core/main -PIPELINE_INIT_INTERVAL 1
directive set /packet_reorder/core/main -PIPELINE_STALL_MODE flush
go extract
