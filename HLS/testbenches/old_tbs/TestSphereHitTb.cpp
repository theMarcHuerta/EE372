...
CCS_MAIN(int argc, char** argv) {
    ...
    sphere_hittable sphere0 = {{11, 0, 0}, 1, LAMBERTIAN, {1, 1, 1}};   // first sphere
    sphere_hittable sphere1 = {{6, 0, 0}, 1, METAL_MAX, {1, 1, 1}};   // second sphere
    sphere_hittable sphere2 = {{18, 0, 0}, 2, LAMBERTIAN, {1, 1, 1}};   // third sphere
