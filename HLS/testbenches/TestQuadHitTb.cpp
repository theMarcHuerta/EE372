...
CCS_MAIN(int argc, char** argv) {
    ...
    quad_hittable quad0 = {{10, -0.5, -0.5}, {0, 1, 0}, {0, 0, 1}, METAL, 0, {1, 0, 0}, {1, 0, 0}, 10, {255, 255, 255}};   // first quad
    quad_hittable quad1 = {{5, -0.5, -0.5}, {0, 1, 0}, {0, 0, 1}, MIRROR, 0, {1, 0, 0}, {1, 0, 0}, 5, {255, 255, 255}};   // second quad
    quad_hittable quad2 = {{18, -0.5, -0.5}, {0, 1, 0}, {0, 0, 1}, METAL, 0, {1, 0, 0}, {1, 0, 0}, 18, {255, 255, 255}};   // third quad
    ...
    if (closest_so_far != 10 || rec.hit_loc.x != 10 || rec.hit_loc.y != 0 || rec.hit_loc.z != 0 || rec.mat != METAL) {
    ...
    if (closest_so_far != 5 || rec.hit_loc.x != 5 || rec.hit_loc.y != 0 || rec.hit_loc.z != 0 || rec.mat != MIRROR) {
        cout << "Test Failed!   " << endl;
        cout << closest_so_far << endl;
        cout << rec.hit_loc.x << endl;
        cout << rec.hit_loc.y << endl;
