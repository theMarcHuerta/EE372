...
// #define METAL_MAX 6
#define EMISSIVE 1
#define MAX_QUADS_IN_BUFFER 64
#define MAX_QUADS_IN_BUFFER_HALF 32
...
struct img_params {
  ...
  uint_11         image_start;   // Height of the image, computed from width and aspect ratio.
  uint_11         image_end;   // Height of the image, computed from width and aspect ratio.
