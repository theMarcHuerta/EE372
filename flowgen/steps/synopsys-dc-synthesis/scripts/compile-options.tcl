...
# Enable Retiming
#-------------------------------------------------------------------------
# Checking and enabling retiming if set
puts "Info: Enable retiming = $enable_retiming"

if {$enable_retiming} {
  append compile_ultra_options " -retime"
}

#-------------------------------------------------------------------------
# Disable Leakage Power Optimization
#-------------------------------------------------------------------------
# Adding command to avoid leakage power optimization
# append compile_ultra_options " -no_power_optimization"
