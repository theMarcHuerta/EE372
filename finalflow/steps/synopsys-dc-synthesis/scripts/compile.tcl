...
# Removing area constraints to focus on meeting timing
set_max_area 0

# # High effort on timing optimization
# set_synthesis_effort high

# # Enable aggressive gate sizing and buffer optimization
# set_buffer_optimization true

# Compile with high timing effort
eval "compile_ultra $compile_ultra_options -timing_high_effort"
